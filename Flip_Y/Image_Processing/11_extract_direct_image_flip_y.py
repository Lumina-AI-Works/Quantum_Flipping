...
if __name__ == "__main__":
    ...
    try:
        ...
        fig1.savefig('../../outputs/Image_2_Direct_Extraction_Circuit_FlipY.png', bbox_inches="tight", dpi=300)
    ...
    cv2.imwrite('../../outputs/Image_3_Output_Watermark_Direct_FlipY.png', wm1 * 255)
    print('Saved extracted watermark to outputs/Image_3_Output_Watermark_Direct_FlipY.png')
