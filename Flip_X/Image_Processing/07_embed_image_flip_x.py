...
if __name__ == "__main__":
    ...
    try:
        ...
        fig.savefig('../../outputs/Image_1_Embedding_and_Attack_Circuit_FlipX.png', bbox_inches="tight", dpi=300)
    ...
    try:
        ...
        cv2.imwrite('../../outputs/Image_1.5_Stego_Image_FlipX.png', stego_attacked)
        print("Saved Stego Image to outputs/Image_1.5_Stego_Image_FlipX.png")
    except Exception as e:
        pass
