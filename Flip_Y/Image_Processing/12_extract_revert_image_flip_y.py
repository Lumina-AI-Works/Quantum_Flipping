...
embed_module = importlib.import_module("10_embed_image_flip_y")
...
def build_approach_2(cover=None, wm=None):
    ...
    qc.name = "Approach 2 (Flip Y Reversion)"
    ...
    # Mathematical inverse of Flip Y is another Flip Y
    for i in range(n):
        qc.x(q_x[i])
...
if __name__ == "__main__":
    ...
    try:
        ...
        fig2.savefig('../../outputs/Image_4_Revert_Extraction_Circuit_FlipY.png', bbox_inches="tight", dpi=300)
    except Exception as e:
        print(f'Notice: Circuit diagram too large to draw/save ({type(e).__name__}). Skipping circuit image.')
        
    wm2 = simulate_and_reconstruct(qc2, n, size, "Approach 2 Revert Flip Y")
    print("Approach 2 Match:", np.array_equal(wm2, original_wm))

    cv2.imwrite('../../outputs/Image_5_Output_Watermark_Revert_FlipY.png', wm2 * 255)
    print('Saved extracted watermark to outputs/Image_5_Output_Watermark_Revert_FlipY.png')
